        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(display_name) || !TextUtils.isEmpty(email) || !TextUtils.isEmpty(password)){
                    ...
                    mRegProgress.setMessage("Espere mientras creamos su cuenta");
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(RegisterActivity.this, "Paso por aca", Toast.LENGTH_SHORT).show();
                    ...
                    mRegProgress.hide();
                    Toast.makeText(RegisterActivity.this, "No se logró completar la operación.", Toast.LENGTH_LONG).show();
